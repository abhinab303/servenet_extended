...
class LstmMultiHead(torch.nn.Module):
    def __init__(self):
...
for epoch in range(epochs):
    ...
    acc_list.to_csv('/home/aa7514/PycharmProjects/servenet_extended/files/t3_lstm_multi_head.csv')
