...
class BertMultiHead(torch.nn.Module):
    ...
    def forward(self, names, descriptions):
        ...
        name_features = name_bert_output[1]

        all_features = self.weight_sum(description_bert_feature, name_features)
        output = self.multiHead(all_features)
        return output
...
for epoch in range(epochs):
    ...
    acc_list.to_csv('/home/aa7514/PycharmProjects/servenet_extended/files/t5_name_ws_multi_head.csv')
