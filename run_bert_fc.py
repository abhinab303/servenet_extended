...
from utils import load_data_train, load_data_test, evaluteTop5, evaluteTop1
from model.bert_fc import ServeNet
...
if __name__ == "__main__":
    ...
    for epoch in range(epochs):
        ...
        print("=======>top1 acc on the test:{}".format(str(evaluteTop1(model, test_dataloader, CLASS_NUM))))
        print("=======>top5 acc on the test:{}".format(str(evaluteTop5(model, test_dataloader))))

    print("=======>top1 acc on the test:{}".format(str(evaluteTop1(model, test_dataloader, CLASS_NUM, True))))
